...
- `sigma_choosing.py`: helpers for spectral-clustering sigma selection.
  ...
  `take_sigma` to generate candidate sigma values from that distribution.
...
from climate_cluster.methods.tools.sigma_choosing import euclidian_distances, take_sigma
